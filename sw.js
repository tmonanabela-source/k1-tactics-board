...
const VERSION = 'k1tb-v1.3.0';
const SHELL = [
  './', './index.html', './manifest.webmanifest', './css/app.css',
  './js/icons.js', './js/logo-data.js', './js/logo.js', './js/kits.js', './js/formations.js', './js/pitch.js', './js/state.js',
  './js/setpieces.js', './js/drills.js', './js/tactics.js', './js/render.js', './js/anim.js', './js/templates.js',
  './js/board.js', './js/gif.js', './js/storage.js', './js/squad.js', './js/teams.js', './js/match.js', './js/session.js', './js/ui.js', './js/panes.js', './js/panes-teams.js', './js/competitions.js', './js/panes-comps.js', './js/panes-home.js', './js/app.js',
