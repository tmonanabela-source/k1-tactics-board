...
| **Competitions** | Host a league (round robin, 1 or 2 legs), a groups + knockout tournament or a knockout cup · any clubs, link your own teams · auto fixtures with kick-off times and pitch allocation · scores, penalties, scorers · standings with points/GD/GF/head-to-head tiebreakers and form · auto-advancing bracket, third place, champion · golden boot · run a fixture live in Match day and the result writes back · share as WhatsApp text, print the programme, export JSON |
