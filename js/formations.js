...
(function (K1) {
  ...
  const ELEVEN = [
    ...
    /* ---------------------------------------- the 4-2-2-2 family (De Zerbi · Fàbregas) */
    { id: '4222dz', name: '4-2-2-2 · base (De Zerbi)', tags: ['De Zerbi', '4-2-2-2'], desc: 'The magic square: double pivot, two inside tens in the half-spaces, two strikers. Nobody starts wide, so the full-backs own the touchline.',
      slots: [GK, S('RB', 2, .30, .92), S('RCB', 4, .19, .60), S('LCB', 5, .19, .40), S('LB', 3, .30, .08),
        S('RDM', 6, .38, .57), S('LDM', 8, .38, .43), S('RAM', 7, .60, .70), S('LAM', 10, .60, .30), S('RS', 9, .80, .57), S('LS', 11, .80, .43)] },
    { id: '4222dzw', name: '4-2-2-2 · De Zerbi variant (wide forwards)', tags: ['De Zerbi', '4-2-2-2'], desc: 'His own version: the front two are not strikers, they are wide forwards pinned to the touchlines, with two tens inside them in the half-spaces. The two tens put the centre-backs in a trap — step up and the space behind is for the winger, drop off and we own midfield.',
      slots: [GK, S('RB', 2, .30, .90), S('RCB', 4, .19, .60), S('LCB', 5, .19, .40), S('LB', 3, .30, .10),
        S('RDM', 6, .38, .57), S('LDM', 8, .38, .43), S('RAM', 10, .62, .64), S('LAM', 9, .62, .36), S('RW', 7, .80, .95), S('LW', 11, .80, .05)] },
    { id: '244dz', name: '2-4-4 · the build trap (De Zerbi)', tags: ['De Zerbi', 'In possession'], desc: 'Two centre-backs invite the press, full-backs step up level with the pivots to make a four, and four attackers pin the back line. Win the first pass and you are 4v4 behind their press.',
      slots: [S('GK', 1, .13, .5), S('RCB', 4, .22, .58), S('LCB', 5, .22, .42),
        S('RB', 2, .47, .92), S('RDM', 6, .44, .60), S('LDM', 8, .44, .40), S('LB', 3, .47, .08),
        S('RAM', 7, .72, .80), S('RS', 9, .84, .58), S('LS', 11, .84, .42), S('LAM', 10, .72, .20)] },
    { id: '325dz', name: '3-2-5 · full-back inverts (De Zerbi)', tags: ['De Zerbi', 'In possession'], desc: 'One full-back tucks in beside the centre-backs, the other stays high. Three build, two pivot, five across the last line.',
      slots: [S('GK', 1, .11, .5), S('RCB', 4, .23, .70), S('CB', 5, .20, .50), S('LCB', 3, .23, .30),
        S('RDM', 6, .44, .60), S('LDM', 8, .44, .40),
        S('RM', 2, .70, .94), S('RAM', 7, .70, .68), S('ST', 9, .84, .50), S('LAM', 10, .70, .32), S('LW', 11, .70, .06)] },
    { id: '4222press', name: '4-2-2-2 high press', tags: ['De Zerbi', 'Out of possession'], desc: 'Two strikers split the centre-backs, the two tens lock the pivots, full-backs jump the winger. The line pushes to halfway.',
      slots: [S('GK', 1, .27, .5), S('RB', 2, .55, .88), S('RCB', 4, .48, .60), S('LCB', 5, .48, .40), S('LB', 3, .55, .12),
        S('RDM', 6, .60, .58), S('LDM', 8, .60, .42), S('RAM', 7, .74, .70), S('LAM', 10, .74, .30), S('RS', 9, .86, .56), S('LS', 11, .86, .44)] },
    { id: '4222block', name: '4-4-2 mid block from 4-2-2-2', tags: ['De Zerbi', 'Out of possession'], desc: 'The two tens drop onto the flanks and it becomes two banks of four. Strikers screen the pivot, units 10 metres apart.',
      slots: [S('GK', 1, .08, .5), S('RB', 2, .30, .82), S('RCB', 4, .26, .60), S('LCB', 5, .26, .40), S('LB', 3, .30, .18),
        S('RM', 7, .46, .84), S('RCM', 6, .42, .58), S('LCM', 8, .42, .42), S('LM', 10, .46, .16), S('RS', 9, .60, .56), S('LS', 11, .60, .44)] },
    { id: '4222como', name: '4-2-2-2 · Como (Fàbregas)', tags: ['Fàbregas', '4-2-2-2'], desc: 'Same square, different accent: one ten is a free playmaker who roams to find the ball, the other holds the far half-space to keep the pitch wide.',
      slots: [GK, S('RB', 2, .32, .90), S('RCB', 4, .20, .60), S('LCB', 5, .20, .40), S('LB', 3, .32, .10),
        S('RDM', 6, .36, .56), S('LDM', 8, .42, .44), S('RAM', 10, .58, .62), S('LAM', 7, .62, .26), S('RS', 9, .80, .54), S('LS', 11, .78, .40)] },
    { id: '235como', name: '2-3-5 · Como in possession', tags: ['Fàbregas', 'In possession'], desc: 'Both full-backs step inside, the 6 drops between the centre-backs, and five attack the last line with the 10 floating between them.',
      slots: [S('GK', 1, .14, .5), S('RCB', 4, .26, .62), S('LCB', 5, .26, .38),
        S('RDM', 2, .48, .72), S('CDM', 6, .44, .50), S('LDM', 3, .48, .28),
        S('RW', 7, .76, .94), S('RAM', 10, .72, .66), S('ST', 9, .84, .50), S('LAM', 8, .72, .34), S('LW', 11, .76, .06)] },
